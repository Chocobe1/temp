...
<html lang="ko">
	...
	<body>
		<div class="wrap">
			...
			<p><a href="testInsert.jsp">테스트_Insert</a></p>
			<p><a href="testSelect.jsp">테스트_Select</a></p>
			<p><a href="testUpdate.jsp">테스트_Update</a></p>
			<p><a href="testDelete.jsp">테스트_Delete</a></p>
		</div>
	</body>
</html>